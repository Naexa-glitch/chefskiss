...
<div class="wrapper">
    ...
    <form class="form-signin">
            <input type="text" class="form-control mb-3" name="code" placeholder="Enter code" required="" />
            <div class="d-grid d-md-block">
        <button href="passwordrecovery.html" class="btn btn-danger" type="submit">Submit</button>
