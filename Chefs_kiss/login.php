    ...
    <header>
        ...
        <nav class="navbar-left align-menu mt-5 d-flex gap-5 ">
            ...
            <ul class="align-menu gap-5 mt-4 ms-5">
                ...
                <li class="top-nav-item"><a class="top-nav-select" href="login.html">Login</a></li>
...
<div class="wrapper">
    <form class="form-signin">
            <input type="text" class="form-control mb-3" name="username" placeholder="Username/Email Address" required="" autofocus="" />
        ...
        <button class="btn btn-danger" type="submit">Login</button>
            ...
            <div class="mt-2">
        <a href="forgotpassword.html" class="text-gray mt-2">Forgot password?</a>
            </div>
    </form>
</div>
